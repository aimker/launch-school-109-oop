# RPS Version where each computer character has a different playing behavior.
# We approach this feature by creating a new choosing method for every character.
